...
const PaymentPanel = {
  ...
  _addPaymentToBudget(budgetSheet, paymentData) {
    try {
      ...
      console.log(`Added payment to budget sheet: ${paymentData.amount} from ${paymentData.tenantName} (Ref: ${referenceNumber})`);
  ...
  /**
   * Generate HTML for the payment recording panel
   * @private
   */
...
<body>
                ...
                <div class="payment-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="amount-${index}" placeholder="e.g., $1200" required>
                            <small>Enter the payment amount (include $ symbol)</small>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        function setFullRent(index) {
            ...
            document.getElementById('amount-' + index).value = tenant.rentAmount;
        }
